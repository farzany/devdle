...
export const Cell = ({
  ...
  const classes = classnames(
    ...
    {
      'bg-white dark:bg-gray-700 border-slate-200 dark:border-slate-600':
        !status,
      'border-gray-700 dark:border-slate-100': value && !status,
      'absent dark:bg-gray-800 text-white bg-gray-700 border-gray-700 dark:text-white border-gray-700 dark:border-slate-700':
        status === 'absent',
